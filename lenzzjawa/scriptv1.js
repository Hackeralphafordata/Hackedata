function openRewards(evt, rewardsClass) {
    var i, tab_reward, tab_reward_link;
    tab_reward = document.getElementsByClassName("tab_reward");
    for (i = 0; i < tab_reward.length; i++) {
        tab_reward[i].style.display = "none";
    }
    tab_reward_link = document.getElementsByClassName("menu-content");
    for (i = 0; i < tab_reward_link.length; i++) {
        tab_reward_link[i].className = tab_reward_link[i].className.replace(" menu-content-active", "");
    }
